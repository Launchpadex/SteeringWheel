...
#define LCD_BKLT_ON() HAL_GPIO_WritePin(LCD_BKLT_GPIO_Port, LCD_BKLT_Pin, GPIO_PIN_SET)
#define LCD_BKLT_OFF() HAL_GPIO_WritePin(LCD_BKLT_GPIO_Port, LCD_BKLT_Pin, GPIO_PIN_RESET)

#define LCD_BASE0        		((uint32_t)0x60000000)
#define LCD_BASE1        		((uint32_t)0x60010000)
