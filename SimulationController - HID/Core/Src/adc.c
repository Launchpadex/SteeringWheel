...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PA2     ------> ADC1_IN3
    */
    GPIO_InitStruct.Pin = THROTTLE_Pin|BRAKE_Pin|CLUTCH_Pin;
  ...
  */
    ...
    PC5     ------> ADC2_IN11
    */
    GPIO_InitStruct.Pin = LEFT_HAND_JOY_Y_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(LEFT_HAND_JOY_Y_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = LEFT_HAND_JOY_X_Pin|LEFT_HAND_JOY_KNOB_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    PB15     ------> ADC4_IN5
    */
    GPIO_InitStruct.Pin = MiskoJOY_X_Pin|MiskoJOY_Y_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA2     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(GPIOA, THROTTLE_Pin|BRAKE_Pin|CLUTCH_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC5     ------> ADC2_IN11
    */
    HAL_GPIO_DeInit(LEFT_HAND_JOY_Y_GPIO_Port, LEFT_HAND_JOY_Y_Pin);

    HAL_GPIO_DeInit(GPIOC, LEFT_HAND_JOY_X_Pin|LEFT_HAND_JOY_KNOB_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PB15     ------> ADC4_IN5
    */
    HAL_GPIO_DeInit(GPIOB, MiskoJOY_X_Pin|MiskoJOY_Y_Pin);
