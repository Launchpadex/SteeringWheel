...
#define MEMORY_FLASH_SIZE    0x1000000   /*128 Mbit => 16 MBytes */
#define MEMORY_BLOCK_SIZE    0x10000    /* 128 blocks of 64 KBytes */
#define MEMORY_SECTOR_SIZE   0x1000     /* 2048 sectors of 4 KBytes */
